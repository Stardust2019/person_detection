...
def video_processing(graph, category_index, video_file_name, show_video_window, camera_id, run_flag, message_queue): 
    #sec = input('Let me know how many seconds you want capture the frame.\n')
    person_count = 0
                ...
                if show_video_window:
                    ...
                    if len(person_boxes) > 0 :
                        if framesNoPerson >= personFindJitter :
                            ...
                            #pic_name = "ff" + str(frame_counter) + "_" + str(person_count)+ str(current_time)+".jpg"
                            pic_name = "firstf" + str(frame_counter) + "_" + str(current_time)+".jpg"
                            person_count+=1
                        ...
                        if framesNoPerson == personFindJitter :
                            ...
                            #pic_name = "lf" + str(frame_counter) + str(person_count)+ str(current_time)+".jpg"
                            pic_name = "lastf" + str(frame_counter) +"_"+ str(current_time)+".jpg"
                            person_count+=1
                    if pic_name is not None and frameWithPerson is not None :
                        ...
                        #with open("./Pictures/" + pic_name, 'rb') as f:
                            #dbImage.create_database(name=pic_name, start_time=now, end_time=current_time, image=f.read(), person='Person')
